...
function htmlToJsx(html) {
  ...
  // Fix value="" on inputs to defaultValue=""
  jsx = jsx.replace(/value=\"([^\"]*)\"/g, 'defaultValue=\"$1\"');
  ...
  // Convert ALL <a> tags to <Link> safely
...
console.log('Fixed JSX anchor tags and regenerated pages.');
